...
use Iginikolaev\Translatable\Test\Model\Continent;
use Iginikolaev\Translatable\Test\Model\Country;
use Iginikolaev\Translatable\Test\Model\CountryGuarded;
use Iginikolaev\Translatable\Test\Model\CountryStrict;
use Iginikolaev\Translatable\Test\Model\CountryTranslation;
use Iginikolaev\Translatable\Test\Model\City;
use Iginikolaev\Translatable\Test\Model\CityTranslation;
use Iginikolaev\Translatable\Test\Model\Company;
use Iginikolaev\Translatable\Test\Model\Vegetable;
...
class TestCoreModelExtension extends TestsBase
{
    ...
    public function test_it_returns_false_if_exists_and_dirty_and_parent_save_returns_false()
    {
        ...
        $event->listen('eloquent*', function ($model) use ($that) {
                return get_class($model) == 'Iginikolaev\Translatable\Test\Model\Country' ? false : true;
            });
    ...
    public function test_it_returns_false_if_does_not_exist_and_parent_save_returns_false()
    {
        ...
        $event = App::make('events');
        $event->listen('eloquent*', function ($model) use ($that) {
                return get_class($model) == 'Iginikolaev\Translatable\Test\Model\Continent' ? false : true;
            });
